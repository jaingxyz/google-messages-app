...
const dumpOverlay = async (label) => {
  return await page.evaluate((label) => {
    ...
    const roots = [
      ...document.querySelectorAll(".cdk-overlay-container, mat-menu, [role='menu'], mat-dialog-container, [role='dialog']"),
    ];
    const buttons = [...document.querySelectorAll("[role='menuitem'], mat-dialog-container button, [role='dialog'] button, .mat-mdc-menu-item")]
      .map((el) => ({
